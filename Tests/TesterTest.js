...
module.exports = class TesterTest extends _Tester
{
    ...
    testValidReturnsSame()
    {
        ...
        this.assertSame('', Tester.valid('', 'string', 'boolean', 'function', 'object', 'regexp', 'null', 'array', 'number'))
        this.assertSame(0, Tester.valid(0, 'string', 'boolean', 'function', 'object', 'regexp', 'null', 'array', 'number'))
        this.assertSame(null, Tester.valid(null, 'string', 'boolean', 'function', 'object', 'regexp', 'null', 'array', 'number'))
        this.assertSame(false, Tester.valid(false, 'string', 'boolean', 'function', 'object', 'regexp', 'null', 'array', 'number'))
        this.assertSame(Object, Tester.valid(Object, 'string', 'boolean', 'function', 'object', 'regexp', 'null', 'array', 'number'))
        this.assertSame(new Object(), Tester.valid(new Object(), 'string', 'boolean', 'function', 'object', 'regexp', 'null', 'array', 'number'))
        this.assertSame([], Tester.valid([], 'string', 'boolean', 'function', 'object', 'regexp', 'null', 'array', 'number'))
        this.assertSame(/^/, Tester.valid(/^/, 'string', 'boolean', 'function', 'object', 'regexp', 'null', 'array', 'number'))
    }
